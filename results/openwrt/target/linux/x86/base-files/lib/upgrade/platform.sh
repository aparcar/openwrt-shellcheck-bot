...
In openwrt/target/linux/x86/base-files/lib/upgrade/platform.sh line 74:
	export_bootdevice && export_partdevice diskdev 0 || {
                          ^-- SC2015: Note that A && B || C is not if-then-else. C may run when A is true.


In openwrt/target/linux/x86/base-files/lib/upgrade/platform.sh line 107:
...
In openwrt/target/linux/x86/base-files/lib/upgrade/platform.sh line 126:
