...
In openwrt/target/linux/ath79/generic/base-files/lib/preinit/10_fix_eth_mac.sh line 11:
...
In openwrt/target/linux/ath79/generic/base-files/lib/preinit/10_fix_eth_mac.sh line 15:
		ip link set dev eth0 address $(mtd_get_mac_ascii u-boot-env0 ethaddr)
                                             ^-- SC2046: Quote this to prevent word splitting.


In openwrt/target/linux/ath79/generic/base-files/lib/preinit/10_fix_eth_mac.sh line 18:
