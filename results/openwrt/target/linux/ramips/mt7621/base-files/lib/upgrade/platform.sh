...
In openwrt/target/linux/ramips/mt7621/base-files/lib/upgrade/platform.sh line 131:
...
In openwrt/target/linux/ramips/mt7621/base-files/lib/upgrade/platform.sh line 132:
