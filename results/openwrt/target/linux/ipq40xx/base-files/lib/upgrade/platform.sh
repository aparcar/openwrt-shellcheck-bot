...
In openwrt/target/linux/ipq40xx/base-files/lib/upgrade/platform.sh line 66:
...
In openwrt/target/linux/ipq40xx/base-files/lib/upgrade/platform.sh line 80:
...
In openwrt/target/linux/ipq40xx/base-files/lib/upgrade/platform.sh line 82:
		tar Oxf $tar_file ${board_dir}/root | mtd write - rootfs
                        ^-------^ SC2086: Double quote to prevent globbing and word splitting.
                                  ^----------^ SC2086: Double quote to prevent globbing and word splitting.
...
In openwrt/target/linux/ipq40xx/base-files/lib/upgrade/platform.sh line 98:
