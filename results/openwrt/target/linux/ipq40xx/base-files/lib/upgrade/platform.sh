...
In openwrt/target/linux/ipq40xx/base-files/lib/upgrade/platform.sh line 34:
...
In openwrt/target/linux/ipq40xx/base-files/lib/upgrade/platform.sh line 58:
...
In openwrt/target/linux/ipq40xx/base-files/lib/upgrade/platform.sh line 61:
...
In openwrt/target/linux/ipq40xx/base-files/lib/upgrade/platform.sh line 69:
	local board_dir=$(tar tf $tar_file | grep -m 1 '^sysupgrade-.*/$')
                                 ^-------^ SC2086: Double quote to prevent globbing and word splitting.
...
In openwrt/target/linux/ipq40xx/base-files/lib/upgrade/platform.sh line 72:
...
In openwrt/target/linux/ipq40xx/base-files/lib/upgrade/platform.sh line 90:
...
In openwrt/target/linux/ipq40xx/base-files/lib/upgrade/platform.sh line 93:
