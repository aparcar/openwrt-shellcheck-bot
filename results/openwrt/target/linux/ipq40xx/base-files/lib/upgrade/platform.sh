...
In openwrt/target/linux/ipq40xx/base-files/lib/upgrade/platform.sh line 39:
...
In openwrt/target/linux/ipq40xx/base-files/lib/upgrade/platform.sh line 62:
...
In openwrt/target/linux/ipq40xx/base-files/lib/upgrade/platform.sh line 65:
...
In openwrt/target/linux/ipq40xx/base-files/lib/upgrade/platform.sh line 73:
	local board_dir=$(tar tf $tar_file | grep -m 1 '^sysupgrade-.*/$')
                                 ^-------^ SC2086: Double quote to prevent globbing and word splitting.
...
In openwrt/target/linux/ipq40xx/base-files/lib/upgrade/platform.sh line 76:
...
In openwrt/target/linux/ipq40xx/base-files/lib/upgrade/platform.sh line 94:
...
In openwrt/target/linux/ipq40xx/base-files/lib/upgrade/platform.sh line 97:
