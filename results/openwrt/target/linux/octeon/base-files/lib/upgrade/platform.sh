...
In openwrt/target/linux/octeon/base-files/lib/upgrade/platform.sh line 51:
...
In openwrt/target/linux/octeon/base-files/lib/upgrade/platform.sh line 58:
...
In openwrt/target/linux/octeon/base-files/lib/upgrade/platform.sh line 66:
...
In openwrt/target/linux/octeon/base-files/lib/upgrade/platform.sh line 98:
...
In openwrt/target/linux/octeon/base-files/lib/upgrade/platform.sh line 115:
...
In openwrt/target/linux/octeon/base-files/lib/upgrade/platform.sh line 116:
...
In openwrt/target/linux/octeon/base-files/lib/upgrade/platform.sh line 117:
