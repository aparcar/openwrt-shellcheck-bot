...
In openwrt/package/kernel/mac80211/files/lib/netifd/wireless/mac80211.sh line 95:
	local __out= oifs
                   ^-- SC1007: Remove space after = if trying to assign a value (for empty string, use var='' ... ).


In openwrt/package/kernel/mac80211/files/lib/netifd/wireless/mac80211.sh line 100:
		set -- $capab
                       ^----^ SC2086: Double quote to prevent globbing and word splitting.
...
In openwrt/package/kernel/mac80211/files/lib/netifd/wireless/mac80211.sh line 112:
	local __out= oifs
                   ^-- SC1007: Remove space after = if trying to assign a value (for empty string, use var='' ... ).


In openwrt/package/kernel/mac80211/files/lib/netifd/wireless/mac80211.sh line 117:
		set -- $capab
                       ^----^ SC2086: Double quote to prevent globbing and word splitting.
...
In openwrt/package/kernel/mac80211/files/lib/netifd/wireless/mac80211.sh line 158:
					case "$(( ($channel / 4) % 2 ))" in
                                                   ^------^ SC2004: $/${} is unnecessary on arithmetic variables.
...
In openwrt/package/kernel/mac80211/files/lib/netifd/wireless/mac80211.sh line 885:
...
In openwrt/package/kernel/mac80211/files/lib/netifd/wireless/mac80211.sh line 887:
		beacon-interval $beacon_int
                                ^---------^ SC2086: Double quote to prevent globbing and word splitting.
...
In openwrt/package/kernel/mac80211/files/lib/netifd/wireless/mac80211.sh line 991:
...
In openwrt/package/kernel/mac80211/files/lib/netifd/wireless/mac80211.sh line 1026:
...
In openwrt/package/kernel/mac80211/files/lib/netifd/wireless/mac80211.sh line 1111:
