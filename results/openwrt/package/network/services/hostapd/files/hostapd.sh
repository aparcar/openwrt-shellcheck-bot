...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 342:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 361:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 588:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 593:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 634:
			[ "$eapol_version" -ge "1" -a "$eapol_version" -le "2" ] && append bss_conf "eapol_version=$eapol_version" "$N"
                                                   ^-- SC2166: Prefer [ p ] && [ q ] as [ p -a q ] is not well defined.


In openwrt/package/network/services/hostapd/files/hostapd.sh line 645:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 794:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 1146:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 1237:
						if [ "$ca_cert2_usesystem" -eq "1" -a -f "/etc/ssl/certs/ca-certificates.crt" ]; then
                                                                                   ^-- SC2166: Prefer [ p ] && [ q ] as [ p -a q ] is not well defined.


In openwrt/package/network/services/hostapd/files/hostapd.sh line 1285:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 1322:
