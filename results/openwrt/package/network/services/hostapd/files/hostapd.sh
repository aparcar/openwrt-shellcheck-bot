...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 285:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 292:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 293:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 304:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 310:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 311:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 495:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 500:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 552:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 578:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 753:
			[ -n "$macfile" -a -f "$macfile" ] && cat "$macfile"
                                        ^-- SC2166: Prefer [ p ] && [ q ] as [ p -a q ] is not well defined.


In openwrt/package/network/services/hostapd/files/hostapd.sh line 757:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 801:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 825:
		($log_8021x  << 1) | \
                 ^--------^ SC2004: $/${} is unnecessary on arithmetic variables.


In openwrt/package/network/services/hostapd/files/hostapd.sh line 826:
		($log_radius << 2) | \
                 ^---------^ SC2004: $/${} is unnecessary on arithmetic variables.
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 828:
		($log_driver << 4) | \
                 ^---------^ SC2004: $/${} is unnecessary on arithmetic variables.


In openwrt/package/network/services/hostapd/files/hostapd.sh line 829:
		($log_iapp   << 5) | \
                 ^-------^ SC2004: $/${} is unnecessary on arithmetic variables.


In openwrt/package/network/services/hostapd/files/hostapd.sh line 830:
		($log_mlme   << 6)   \
                 ^-------^ SC2004: $/${} is unnecessary on arithmetic variables.
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 868:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 1125:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 1162:
