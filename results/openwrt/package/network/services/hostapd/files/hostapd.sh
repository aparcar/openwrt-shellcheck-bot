...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 363:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 371:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 382:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 711:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 1044:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 1073:
		($log_mlme   << 6)   \
                 ^-------^ SC2004: $/${} is unnecessary on arithmetic variables.


In openwrt/package/network/services/hostapd/files/hostapd.sh line 1093:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 1270:
			if [ "$ca_cert_usesystem" -eq "1" -a -f "/etc/ssl/certs/ca-certificates.crt" ]; then
                                                          ^-- SC2166: Prefer [ p ] && [ q ] as [ p -a q ] is not well defined.


In openwrt/package/network/services/hostapd/files/hostapd.sh line 1319:
						if [ "$ca_cert2_usesystem" -eq "1" -a -f "/etc/ssl/certs/ca-certificates.crt" ]; then
                                                                                   ^-- SC2166: Prefer [ p ] && [ q ] as [ p -a q ] is not well defined.


In openwrt/package/network/services/hostapd/files/hostapd.sh line 1367:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 1484:
