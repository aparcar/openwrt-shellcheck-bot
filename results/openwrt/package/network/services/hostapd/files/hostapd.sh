...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 901:
				[ -n "$r0kh" -a -n "$r1kh" ] || {
                                             ^-- SC2166: Prefer [ p ] && [ q ] as [ p -a q ] is not well defined.


In openwrt/package/network/services/hostapd/files/hostapd.sh line 902:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 948:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 996:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 1362:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 1459:
...
In openwrt/package/network/services/hostapd/files/hostapd.sh line 1576:
