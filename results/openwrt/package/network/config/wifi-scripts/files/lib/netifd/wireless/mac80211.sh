...
In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 292:
			HE*) op_class=$((132 + $vht_oper_chwidth))
                                               ^---------------^ SC2004: $/${} is unnecessary on arithmetic variables.


In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 324:
			vht_cap="$(($vht_cap | $cap))"
                                    ^------^ SC2004: $/${} is unnecessary on arithmetic variables.
                                               ^--^ SC2004: $/${} is unnecessary on arithmetic variables.


In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 330:
		cap_rx_stbc=$((($vht_cap >> 8) & 7))
                                ^------^ SC2004: $/${} is unnecessary on arithmetic variables.


In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 332:
		vht_cap="$(( ($vht_cap & ~(0x700)) | ($cap_rx_stbc << 8) ))"
                              ^------^ SC2004: $/${} is unnecessary on arithmetic variables.
                                                      ^----------^ SC2004: $/${} is unnecessary on arithmetic variables.


In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 340:
			RXLDPC:0x10::$rxldpc \
                                     ^-----^ SC2086: Double quote to prevent globbing and word splitting.
...
In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 343:
...
In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 357:
...
In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 360:
...
In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 375:
...
In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 389:
		[ "$(($vht_cap & 58720256))" -ge 8388608 -a 1 -le "$vht_max_a_mpdu_len_exp" ] && \
                      ^------^ SC2004: $/${} is unnecessary on arithmetic variables.
                                                         ^-- SC2166: Prefer [ p ] && [ q ] as [ p -a q ] is not well defined.


In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 391:
...
In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 399:
...
In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 409:
...
In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 447:
...
In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 527:
	[ "$staidx" -gt 0 -o "$start_disabled" -eq 1 ] && append hostapd_cfg "start_disabled=1" "$N"
                          ^-- SC2166: Prefer [ p ] || [ q ] as [ p -o q ] is not well defined.


In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 529:
...
In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 542:
...
In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 549:
...
In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 581:
	[ -z "$new_phy" -o "$new_phy" = "$phy" ] && return
                        ^-- SC2166: Prefer [ p ] || [ q ] as [ p -o q ] is not well defined.


In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 587:
	local phy="$1"
              ^-^ SC2030: Modification of phy is local (to subshell caused by (..) group).


In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 605:
	[ -n "$phy" ] && {
...
In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 617:
		for phy in $(ls /sys/class/ieee80211 2>/dev/null); do
                           ^-- SC2045: Iterating over ls output is fragile. Use globs.


In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 662:
...
In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 722:
					case "$(( ($channel / 4) % 2 ))" in
                                                   ^------^ SC2004: $/${} is unnecessary on arithmetic variables.


In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 747:
mac80211_setup_adhoc() {
^-- SC2120: mac80211_setup_adhoc references arguments, but none are ever passed.


In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 761:
		case "$key" in
                      ^--^ SC2031: key was modified in a subshell. That change might be lost.


In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 768:
...
In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 775:
				append keyspec "d:0:$(prepare_key_wep "$key")"
                                                                       ^--^ SC2031: key was modified in a subshell. That change might be lost.


In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 912:
	[ "$ret" != 0 -o -z "$supplicant_res" ] && wireless_setup_vif_failed WPA_SUPPLICANT_FAILED
                      ^-- SC2166: Prefer [ p ] || [ q ] as [ p -o q ] is not well defined.


In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 927:
	[ "$ret" != 0 -o -z "$hostapd_res" ] && {
                      ^-- SC2166: Prefer [ p ] || [ q ] as [ p -o q ] is not well defined.


In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 943:
mac80211_setup_supplicant() {
^-- SC2120: mac80211_setup_supplicant references arguments, but none are ever passed.


In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 975:
...
In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 979:
...
In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 987:
				mac80211_setup_supplicant || failed=1
                                ^-----------------------^ SC2119: Use mac80211_setup_supplicant "$@" if function's $1 should mean script's $1.
...
In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 993:
			mac80211_setup_supplicant || failed=1
                        ^-----------------------^ SC2119: Use mac80211_setup_supplicant "$@" if function's $1 should mean script's $1.


In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 1098:
		for file in /sys/kernel/debug/ieee80211/$phy/ath9k*/chanbw /sys/kernel/debug/ieee80211/$phy/ath5k/bwmode; do
                                                        ^--^ SC2231: Quote expansions in this for loop glob to prevent wordsplitting, e.g. "$dir"/*.txt .


In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 1110:
	[ "$rxantenna" = "$prev_rxantenna" -a "$txantenna" = "$prev_txantenna" ] || mac80211_reset_config "$phy"
                                           ^-- SC2166: Prefer [ p ] && [ q ] as [ p -a q ] is not well defined.


In openwrt/package/network/config/wifi-scripts/files/lib/netifd/wireless/mac80211.sh line 1167:
