...
In openwrt/package/network/config/wifi-scripts/files-ucode/lib/netifd/wireless/mac80211.sh line 26:
...
In openwrt/package/network/config/wifi-scripts/files-ucode/lib/netifd/wireless/mac80211.sh line 30:
}
