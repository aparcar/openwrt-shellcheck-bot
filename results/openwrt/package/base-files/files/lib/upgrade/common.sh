...
In openwrt/package/base-files/files/lib/upgrade/common.sh line 218:
			export -n "$line"
                                  ^-----^ SC2163: This does not export 'line'. Remove $/${} for that, or use ${var?} to quiet.
...
In openwrt/package/base-files/files/lib/upgrade/common.sh line 236:
...
In openwrt/package/base-files/files/lib/upgrade/common.sh line 257:
...
In openwrt/package/base-files/files/lib/upgrade/common.sh line 313:
...
In openwrt/package/base-files/files/lib/upgrade/common.sh line 315:
...
In openwrt/package/base-files/files/lib/upgrade/common.sh line 317:
	[ $? -ne 0 ] && exit 1
