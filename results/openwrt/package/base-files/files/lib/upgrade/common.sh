...
In openwrt/package/base-files/files/lib/upgrade/common.sh line 155:
	if read cmdline < /proc/cmdline; then
           ^--^ SC2162: read without -r will mangle backslashes.


In openwrt/package/base-files/files/lib/upgrade/common.sh line 173:
...
In openwrt/package/base-files/files/lib/upgrade/common.sh line 210:
			while read line; do
                              ^--^ SC2162: read without -r will mangle backslashes.
...
In openwrt/package/base-files/files/lib/upgrade/common.sh line 228:
			export -n "$line"
                                  ^-----^ SC2163: This does not export 'line'. Remove $/${} for that, or use ${var?} to quiet.


In openwrt/package/base-files/files/lib/upgrade/common.sh line 230:
...
In openwrt/package/base-files/files/lib/upgrade/common.sh line 270:
...
In openwrt/package/base-files/files/lib/upgrade/common.sh line 309:
...
In openwrt/package/base-files/files/lib/upgrade/common.sh line 311:
	[ $? -ne 0 ] && exit 1
