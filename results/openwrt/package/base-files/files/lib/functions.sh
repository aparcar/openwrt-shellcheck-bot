...
In openwrt/package/base-files/files/lib/functions.sh line 155:
	[ -z "$CONFIG_SECTIONS" ] && return 0
              ^--------------^ SC2153: Possible misspelling: CONFIG_SECTIONS may not be assigned, but CONFIG_SECTION is.


In openwrt/package/base-files/files/lib/functions.sh line 183:
...
In openwrt/package/base-files/files/lib/functions.sh line 192:
	for i in $(grep -s "^/etc/init.d/" "$root/usr/lib/opkg/info/${pkgname}.list"); do
                 ^-- SC2013: To read lines rather than words, pipe/redirect to a 'while read' loop.


In openwrt/package/base-files/files/lib/functions.sh line 208:
...
In openwrt/package/base-files/files/lib/functions.sh line 216:
...
In openwrt/package/base-files/files/lib/functions.sh line 219:
...
In openwrt/package/base-files/files/lib/functions.sh line 256:
...
In openwrt/package/base-files/files/lib/functions.sh line 306:
	echo ${INDEX}
             ^------^ SC2086: Double quote to prevent globbing and word splitting.
...
In openwrt/package/base-files/files/lib/functions.sh line 323:
...
In openwrt/package/base-files/files/lib/functions.sh line 333:
...
In openwrt/package/base-files/files/lib/functions.sh line 338:
...
In openwrt/package/base-files/files/lib/functions.sh line 350:
